...
CREATE TABLE nominacion(
    id_nominacion SERIAL PRIMARY KEY,
...
CREATE TABLE favoritos_peliculas (
    id_favorito_pelicula SERIAL PRIMARY KEY,
    id_user INT NOT NULL,
    id_pelicula INT NOT NULL,
    FOREIGN KEY (id_user) REFERENCES users (id_user),
    FOREIGN KEY (id_pelicula) REFERENCES pelicula (id_pelicula),
    UNIQUE (id_user, id_pelicula)
);

CREATE TABLE favoritos_personas (
    id_favorito_persona SERIAL PRIMARY KEY,
    id_user INT NOT NULL,
    id_persona INT NOT NULL,
    FOREIGN KEY (id_user) REFERENCES users (id_user),
    FOREIGN KEY (id_persona) REFERENCES persona (id_persona),
    UNIQUE (id_user, id_persona)
);
